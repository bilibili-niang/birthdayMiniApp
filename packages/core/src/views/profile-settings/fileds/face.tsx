...
const check = (url: string) => {
  return request({
    url: '/kacat-venue-wap/m/userFaceImg/check',
    method: 'post',
    data: {
      faceImageUrl: url
    }
...
const wrongList = [
  { image: 'https://dev-cdn.kacat.cn/upload/d178ae48c32bbf64b78b814200971fb7.png', title: '非人物照' },
  { image: 'https://dev-cdn.kacat.cn/upload/52c255af8b03520e20a7998eec7ec1e2.png', title: '五官遮挡' },
  { image: 'https://dev-cdn.kacat.cn/upload/fba75213d9ac0c5192d9fd3504238dfd.png', title: '模糊不清' },
  { image: 'https://dev-cdn.kacat.cn/upload/f33233a3d89113f64fec04fe148796d6.png', title: '衣着不当' },
  { image: 'https://dev-cdn.kacat.cn/upload/30d455f94c5090b80ca3427969f69c88.png', title: '角度不正' },
  { image: 'https://dev-cdn.kacat.cn/upload/8fa4eae8b6ccf91d0367eb6d50aa79a1.png', title: '多人照片' }
]
      ...
      return (
        <div class="use-upload-face-image">
          <div class="correct">
            ...
            <div
              class="image"
              style="background-image:url('https://dev-cdn.kacat.cn/upload/f50faac6dee4de514bdee81be285a6a9.png')"
            >
              <div class="badge">
              ...
              {tempImagePath.value ? (
                ...
                <>
                  <div class="album" onClick={onAlbum}>
                    <Image src="https://dev-cdn.kacat.cn/upload/0b855145f6f8807e0d7edfd173ea6ce1.svg" class="icon" />
                  ...
                  <div class="flip" onClick={onFlip}>
                    <Image src="https://dev-cdn.kacat.cn/upload/29110fedc65828edf2e941f6edf96c54.svg" class="icon" />
