import { BasePage, navigateBack, navigateTo, useLogin, useToast, useUpdateManager, useUserStore } from '@kacat/core'
import { defineComponent } from 'vue'
import './style.scss'
import { Image, Button as NativeButton } from '@tarojs/components'
import Icon from '@kacat/ui/src/components/icon'
                ...
                {process.env.TARO_ENV === 'weapp' && isLogin.value && (
                  <div class="item" onClick={() => userStore.bindWechat()}>
                    <div class="label">
                      <Image
                        class="logo"
                        src="https://cdn.kacat.cn/upload/20240903/36235b059bdff7f28a6f21de0b7dde38.svg"
                      />
                      绑定微信
                    </div>
                    {isWechatBind.value ? (
