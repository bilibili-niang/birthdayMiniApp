import { EmptyStatus, useLoading, useLoadingEnd, useModal, useToast } from '@kacat/core'
import { Icon, Search } from '@kacat/ui'
import './style.scss'
import { formatDistance, uuid } from '@kacat/utils'
import { ref } from 'vue'
