...
export const useOpenWeapp = (options: {
  ...
  if (process.env.TARO_ENV === 'h5') {
    const {
      ...
      appId,
      path,
      appLogo = 'https://dev-cdn.kacat.cn/upload/18412487137823edf62eae72585dae7e.svg'
    } = options
          ...
          <div class="use-open-weapp">
            <div class="apps">
              <div class="app">
                <div
                  class="logo"
                  style="background-image:url(https://dev-cdn.kacat.cn/upload/90fbc7a0026ebcc46b86ec5765474b63.svg)"
                ></div>
