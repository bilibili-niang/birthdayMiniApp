...
import { PaginationData } from '@kacat/core'
...
export const $getCouponList = (params: any) => {
  return request({
    url: '/kacat-cornerstone-order-wap/m/couponRecord/list',
    method: 'get',
    withMerchantId: true,
    params
  })
...
export const $postAuditStaticCoupon = (options: {
  ...
  return request({
    url: '/kacat-cornerstone-order-wap/m/goods/coupon/verification',
    method: 'post',
    withMerchantId: true,
    data: options
  })
...
export const $postAuditDynamicCoupon = (options: {
  ...
  return request({
    url: '/kacat-cornerstone-order-wap/m/goods/coupon/dynamic-verification',
    method: 'post',
    withMerchantId: true,
    data: options
  })
...
export const $getCouponAuditRecords = (orderNo: string) => {
  return request<PaginationData<ICouponAuditRecord>>({
    url: `/kacat-cornerstone-order-wap/m/goods/coupon/verification-record/${orderNo}`,
    method: 'get',
    withMerchantId: true
  })
}
