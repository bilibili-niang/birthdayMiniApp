...
import { SCENE_STORE } from '@kacat/config'

/** 获取微信小程序授权链接 */
export const getWeappAuthURL = () => {
  return request({
    url: '/kacat-cornerstone-wechat/open/authUrl',
    method: 'get',
    params: {
      merchant_id: useUserStore().userInfo?.merchantId,
...
export const postWeappAuthCallback = (authCode: string) => {
  return request({
    url: '/kacat-cornerstone-wechat/open/authCallback',
    method: 'post',
    data: {
      authCode: authCode
    }
...
export const getWechatOfficialAccountAuthURL = (accountId: string) => {
  return request({
    url: '/kacat-cornerstone-wechat/open/fastRegisterAuthUrl',
    method: 'get',
    params: {
...
export const postWechatOfficialAccountAuthCallback = (options: { accountId: string; ticket: string }) => {
  return request({
    url: '/kacat-cornerstone-wechat/open/fastRegisterAuthCallback',
    method: 'post',
    params: {
...
export const getWechatAccountList = (): ResponseBody<IWechatAccountRecord> => {
  return request({
    url: '/kacat-cornerstone-wechat/account',
    method: 'get',
    params: {
      scene: useAppStore().scene,
      status: 1
...
export const getWeappBasicInfo = (accountId: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/miniapp/${accountId}/info/basic`,
    method: 'get'
  })
}
...
export const getWeappVersionInfo = (accountId: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/miniapp/${accountId}/info/version`,
    method: 'get'
  })
}
...
export const createEnterpriseWeapp = (options: ICreateEnterpriseWeappOptions): ResponseBody<any> => {
  return request({
    url: '/kacat-cornerstone-wechat/open/fastRegisterMiniprogram',
    method: 'post',
    data: options
  })
}
...
export const upgradeTrailWeapp = (accountId: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/miniapp/${accountId}/commit`,
    method: 'post'
  })
}
...
export const auditWeapp = (accountId: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/${accountId}/version/submit/audit`,
    method: 'post'
  })
}
...
export const releaseWeapp = (accountId: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/${accountId}/version/release`,
    method: 'post'
  })
}
...
export const getTrialWeappQRCode = (version: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/miniapp/${version}/trialQRCode`,
    method: 'get'
  })
}
...
export const getWechatQRCodeTicket = () => {
  return request({
    url: '/kacat-cornerstone-wechat/open/fastRegisterQRCodeTicket',
    method: 'get'
  })
}
...
export const checkWechatQRCodeTicketStatus = (ticket: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/open/fastRegisterQRCodeResult/${ticket}`,
    method: 'get'
  })
}
...
export const createTrialWeapp = (options: ICreateTrialWeappOptions) => {
  return request({
    url: '/kacat-cornerstone-wechat/open/fastRegisterBetaMiniprogram',
    method: 'post',
    data: {
      scene: useAppStore().scene,
      ...options
...
export const updatePrivacy = (accountId: string) => {
  return request({
    url: `/kacat-cornerstone-wechat/${accountId}/version/update/privacy`,
    method: 'POST'
  })
}
...
export const getWebviewAuthFile = (accountId: string): ResponseBody<any> => {
  return request({
    url: `/kacat-cornerstone-wechat/miniapp/${accountId}/webViewDomain/confirmFile`,
    method: 'GET'
  })
}
...
export const updateWebviewUrls = (accountId: string, domains: string[]): ResponseBody<any> => {
  return request({
    url: `/kacat-cornerstone-wechat/miniapp/${accountId}/webViewDomain`,
    method: 'POST',
    data: {
      domains
    }
