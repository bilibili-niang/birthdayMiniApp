...
export const $getOpenAppCashierList = (params: RequestPagination<{}>) => {
  return request({
    url: '/kacat-cornerstone-open/open/page',
    method: 'get',
    params: {
      ...params
    }
...
export const $createOpenAppCashier = (options: ICashierOptions) => {
  return request({
    url: '/kacat-cornerstone-open/open',
    method: 'post',
    data: {
      ...options
    }
...
export const $updateOpenAppCashier = (id: string, data: ICashierOptions) => {
  return request({
    url: `/kacat-cornerstone-open/open/${id}`,
    method: 'put',
    data: {
      ...data
    }
...
export const $getOpenAppCashierMallURL = (appId: string) => {
  return request({
    url: `/kacat-cornerstone-open/open/getShoppingMallUrl/${appId}`
  })
}
