import { Button, Modal, message } from '@kacat/ui'
...
export default defineComponent({
  ...
  setup() {
    ...
    const authWeapp = async () => {
      // // 定义要跳转的 URL
      // const url = 'https://dev-api.kacat.cn/kacat-cornerstone-wechat/open/authUrl'
      ...
      }/kacat-cornerstone-wechat/open/authUrl?merchant_id=${userStore.userInfo?.merchantId}&scene=${useAppStore().scene}`
