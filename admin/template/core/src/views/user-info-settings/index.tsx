...
import { SchemaForm, type Schema } from '@kacat/jsf'
import { Icon, JsonView, message, Switch, Table, Tooltip } from '@kacat/ui'
    ...
    return () => {
      return (
        <div class="user-info-settings-page">
          {import.meta.env.DEV && (
            <div class="user-info-settings-page__preview scroller">
              <JsonView data={state} defaultUnfold />
            </div>
          )}
          <div class="user-info-settings-page__form scroller">
