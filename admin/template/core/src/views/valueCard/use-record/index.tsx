...
import { useAppStore, useModal, useRequestErrorMessage, useSearchTable, useTableAction } from '@kacat/core'
...
const ValueCardUseRecord = defineComponent({
  ...
  setup(props) {
    const { Table } = useSearchTable({
      ...
      exportURL: '/kacat-cornerstone-goods/cardPaymentRecord/export?scene=' + useAppStore().scene,
      filter: {
        list: [
          {
            key: 'recordNo',
