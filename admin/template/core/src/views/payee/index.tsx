...
import './style.scss'
import { Button, Icon, JsonView, message, Switch, Table } from '@kacat/ui'
import { CommonWidgetPropsDefine, SchemaForm, type Schema } from '@kacat/jsf'
...
import { Spin, useAppStore, AuthButton } from '../../../lib'
import { $getShopList } from '../../../../../apps/cs/shophub/src/api/shop'
import { data } from '../../../../../apps/cs/tongbao/src/api/records/data'
