...
import './style.scss'
import { Button, Input } from '@kacat/ui'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => {
      ...
      const link = coord
        ? `https://apis.map.qq.com/tools/locpicker?search=1&type=1&key=QAYBZ-5PKWK-F7TJC-AFAFD-A3ESO-LFFA2&referer=kacat&coord=${coord}`
        : 'https://apis.map.qq.com/tools/locpicker?search=1&type=1&key=QAYBZ-5PKWK-F7TJC-AFAFD-A3ESO-LFFA2&referer=kacat'
      return (
