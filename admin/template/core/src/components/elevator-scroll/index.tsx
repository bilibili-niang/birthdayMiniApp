// 电梯滚动组件
// @example https://git.wunsun.com/kuoka/fe/kuoka-enterprise-admin-fe/blob/tongqiyun/apps/cs/tongqiyun/src/views/activity/recreation/create/index.tsx
import './index.scss'
import { computed, defineComponent, nextTick, onBeforeUnmount, onMounted, ref, Transition, watch } from 'vue'
import { Button, Icon, JsonView, message } from '@kacat/ui'
import Collapse from '@kacat/jsf/src/components/collapse'
import { SchemaErrors, Spin, useContextMenu } from '@kacat/core'
import { SchemaForm, validateForm } from '@kacat/jsf'
