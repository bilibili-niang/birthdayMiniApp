import { defineComponent, onMounted, reactive, ref, shallowRef, watch, type PropType, readonly } from 'vue'
import './style.scss'
import { Button, Empty, Icon, Input, message, Textarea } from '@kacat/ui'
import { PREFIX_CLS } from '@kacat/config'
import { formatDistance, loadTMap } from '@kacat/utils'
...
// CJRBZ-7YZCD-5W64C-HEPNU-7GIK2-J2B4W
    ...
    const initMap = () => {
      const center =
        props.latitude && props.latitude
          ...
          : new TMap.LatLng(24.621999, 118.038307)
    ...
    return () => {
      return (
        <div class="use-poi-choose">
          ...
          <h3>周边地点</h3>
          <div class="use-poi-choose__list scroller" key={listKey.value}>
