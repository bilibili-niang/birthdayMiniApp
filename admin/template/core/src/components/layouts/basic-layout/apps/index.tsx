      ...
      return (
        <>
          {/* <div class="basic-layout__app-item clickable --active">
            <img src="https://dev-cdn.cardcat.cn/kacat/example_01.png" draggable={false} />
            <strong>精选商城</strong>
          </div>
          <Badge size="small" offset={[-8, 3]} count={8}>
            <div class="basic-layout__app-item clickable">
              <img src="https://dev-cdn.cardcat.cn/kacat/example_02.png" style="padding: 3px;" draggable={false} />
              <strong>供应链平台</strong>
            </div>
          </Badge> */}
                  ...
                  <div class="basic-layout__app-popover">
                    {item.children!.map((child) => {
                      return (
                        ...
                        >
                          <img class="hyperelliptic" src="https://dev-cdn.cardcat.cn/kacat/example_03.png" alt="" />
                          <div>
