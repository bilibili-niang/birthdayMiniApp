import { type PropType, type Ref, computed, defineComponent, isRef, onMounted, onUnmounted, ref } from 'vue'
import './sub-page.scss'
import test from '../../utils/test'
import { Icon, Modal } from '@kacat/ui'
...
const SubPage = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => (
      <div class="image-selector__sub-page scroller" ref={scrollerRef}>
            ...
            return (
              <div key={item.url} class="image-selector__item" style={style}>
                ...
                {isVideo ? (
                  ...
                  // <audio src={item.url} autoplay={false} controls />
                ...
                <div class="lego-resource__layer">
                  ...
                  >
                    <Icon class="icon" name="check-small"></Icon>
                    <span>{'选择'}</span>
                  </div>
                  <div
                    class="handler-button clickable"
