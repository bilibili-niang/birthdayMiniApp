import { loadTMap } from '@kacat/utils'
import useModal from '../useModal'
import './style.scss'
import { Button, Empty, Icon, Input, InputNumber, message, Slider, Switch } from '@kacat/ui'
...
import { ImageWidget } from '@kacat/jsf/src/theme/default/widgets/image'
  ...
  const renderImages = () => {
    ...
    layers.value.forEach((item) => {
      ...
      if (import.meta.env.DEV) {
        _image = _image.replace('https://dev-cdn.kacat.cn', '')
      }
