import ImageModalManifest from '@kacat/deck/src/canvas-components/common/image-modal/manifest'
import { defineAction } from '../utils'
import ImageModal from '@kacat/deck/src/canvas-components/common/image-modal/render'
