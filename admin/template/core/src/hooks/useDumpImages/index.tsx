import { Button, Modal, Spin } from '@kacat/ui'
import { uniq } from 'lodash'
import { type PropType, computed, defineComponent, onMounted, ref, toRaw } from 'vue'
import './style.scss'
    ...
    return () => {
      return (
        <div class="dump-image-modal">
          ...
          <div class="dump-image-modal__list scroller">
