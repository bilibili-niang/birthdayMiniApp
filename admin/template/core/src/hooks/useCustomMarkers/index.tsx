...
import './style.scss'
import { Button, Empty, Icon, message, InputNumber, Tooltip, Slider } from '@kacat/ui'
    ...
    useImageSelector({
      ...
      onSuccess: (res) => {
        if (import.meta.env.DEV) {
          layers.value[index].image = res.url.replace('https://dev-cdn.kacat.cn', '')
        } else {
  ...
  watch(
    ...
    () => {
      ...
      scene.on('loaded', () => {
        ...
        // drawRect.on(DrawEvent.Dragging, (item) => {
        // 会影响渲染性能
