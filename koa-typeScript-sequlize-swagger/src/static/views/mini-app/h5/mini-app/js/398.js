"use strict";
(self["webpackJsonp"] = self["webpackJsonp"] || []).push([[398],{
...
var useProfileStore = (0,pinia/* defineStore */.nY)('StoreProfile', function () {
  var balance = (0,reactivity_esm_bundler/* ref */.KR)(0);
  var balanceAccount = (0,reactivity_esm_bundler/* ref */.KR)();
  var isBalanceAvailable = (0,runtime_core_esm_bundler/* computed */.EW)(function () {
    return balanceAccount.value && balance.value > 0;
  });
  var balanceYuan = (0,runtime_core_esm_bundler/* computed */.EW)(function () {
    return Math.round(balance.value / 100 * 100) / 100;
  });
  var balanceText = (0,runtime_core_esm_bundler/* computed */.EW)(function () {
