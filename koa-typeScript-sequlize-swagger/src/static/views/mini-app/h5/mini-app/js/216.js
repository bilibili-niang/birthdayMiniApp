"use strict";
(self["webpackJsonp"] = self["webpackJsonp"] || []).push([[216],{
...
// EXTERNAL MODULE: ./src/components/goods-list/index.tsx
var goods_list = __webpack_require__(7889);
...
/* harmony default export */ var coupon = ((0,runtime_core_esm_bundler/* defineComponent */.pM)({
  props: {
    groupId: {
      type: String,
      required: true
  ...
  setup: function setup(props) {
    var pagination = (0,lib/* usePagination */.WQ)({
      requestHandler: function requestHandler(params) {
        return (0,discount_coupon/* $getDiscountCouponReceiveList */.nr)((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({}, params), {}, {
    ...
    return function () {
      ...
      return (0,runtime_core_esm_bundler/* createVNode */.bF)("div", {
        "class": "goods-group-coupon-receiver"
      }, [(0,runtime_core_esm_bundler/* createVNode */.bF)("div", {
        "class": "goods-group-coupon-receiver__title"
      }, [(0,runtime_core_esm_bundler/* createTextVNode */.eW)("\u4EE5\u4E0B\u5546\u54C1\u9002\u7528\uFF1A")]), (0,runtime_core_esm_bundler/* createVNode */.bF)(promotion/* default */.A, {
        "pagination": pagination,
        "scene": constants_discount_coupon/* DiscountCouponScene */.sj.goodsGroup,
        "goodsGroupId": props.groupId
      }, null)]);
    };
  }
}));
;// ./src/packageA/goods/group/index.tsx
...
/* harmony default export */ var group = ((0,runtime_core_esm_bundler/* defineComponent */.pM)({
  setup: function setup() {
    var _router$params$id;
    var router = taro/* default.useRouter */.Ay.useRouter();
    var groupId = (0,reactivity_esm_bundler/* ref */.KR)((_router$params$id = router.params.id) !== null && _router$params$id !== void 0 ? _router$params$id : '');
    ...
    var groupDetailRef = (0,reactivity_esm_bundler/* ref */.KR)();
    var getDetail = function getDetail() {
      (0,api/* requestGetGoodsGroupDetail */.C1)(groupId.value).then(function (res) {
        if (res.code === 200) {
    ...
    var _usePagination = (0,lib/* usePagination */.WQ)({
        requestHandler: function requestHandler(params) {
          return (0,api/* requestGetGroupGoods */.DJ)((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({}, params), {}, {
    ...
    fetchData();
    var goodsList = (0,runtime_core_esm_bundler/* computed */.EW)(function () {
    ...
    return function () {
      var _groupDetailRef$value, _groupDetailRef$value2;
      return (0,runtime_core_esm_bundler/* createVNode */.bF)(lib/* BasePage */.vo, {
        "navigator": {
          title: (_groupDetailRef$value = (_groupDetailRef$value2 = groupDetailRef.value) === null || _groupDetailRef$value2 === void 0 ? void 0 : _groupDetailRef$value2.name) !== null && _groupDetailRef$value !== void 0 ? _groupDetailRef$value : ''
        }
      }, {
        default: function _default() {
          return [(0,runtime_core_esm_bundler/* createVNode */.bF)(components/* ScrollView */.BM, {
            ...
            default: function _default() {
              ...
              }, [(0,runtime_core_esm_bundler/* createVNode */.bF)(coupon, {
                "groupId": groupId.value
              }, null), (0,runtime_core_esm_bundler/* createVNode */.bF)(goods_list/* default */.A, {
                "list": goodsList.value
              }, null), (0,runtime_core_esm_bundler/* createVNode */.bF)(ErrorStatus, null, null), (0,runtime_core_esm_bundler/* createVNode */.bF)(Empty, null, null), (0,runtime_core_esm_bundler/* createVNode */.bF)(Loading, null, null), (0,runtime_core_esm_bundler/* createVNode */.bF)(EndTip, null, null)])];
            }
          })];
        }
      });
