...
export const ScrollTabItem = (props, { slots }) => {
  ...
  if (!cnt) return null
  return <div class="kacat-scroll-tab__item">{cnt}</div>
}
...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    query.select(`.${id} .kacat-scroll-tab__scroll`).scrollOffset()
    ...
    return () => {
      return (
        <div class={['kacat-scroll-tab', id, props.vertical && 'kacat-scroll-tab--vertical']} ref={containerRef}>
          <ScrollView
            class="kacat-scroll-tab__scroll"
            ...
            scrollWithAnimation
          >
            <div class="kacat-scroll-tab__content">{slots.default?.()}</div>
          </ScrollView>
        </div>
      )
    }
