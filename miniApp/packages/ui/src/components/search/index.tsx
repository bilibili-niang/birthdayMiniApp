...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => {
      return (
        <div class={['kacat-search', content.value.length > 0 && 'clearable']}>
          <div class="kacat-search__content">
            <Icon class="kacat-search__icon" name="search" />
            <div class="kacat-search__input-wrap">
              {process.env.TARO_ENV === 'h5' ? (
                ...
                >
                  <input
                    ref={inputRef}
                    type="search"
                    class="kacat-search__input input"
                    value={content.value}
                    onInput={onChange}
                    onFocus={onFocus}
                    onBlur={onBlur}
              ...
              {placeholderVisible.value && keywordsList.value.length > 1 && (
                <TextSlider
                  class="kacat-search__placeholder placeholder"
            ...
            {props.clearAble && (
              <div class="kacat-search__clear" onClick={clear}>
