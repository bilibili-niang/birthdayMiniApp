...
import { renderAnyNode, uuid } from '@kacat/utils'
import { BaseEventOrigFunction, ScrollView, ScrollViewProps } from '@tarojs/components'
import Kacat, { emitter, navigateBack, useAppStore, useLogin, useUserStore } from '@kacat/core/lib'
      ...
      return (
        <div class="c_base-page__need-login">
          <EmptyStatus
            title="未登录"
            description="请登录后查看"
            image={'https://dev-cdn.kacat.cn/upload/915ed108d5d030f377d56c9317276b09.svg'}
            actions={() => {
              return (
                <>
