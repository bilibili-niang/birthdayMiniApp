...
import { useLoading, useLoadingEnd, useLogin, useResponseMessage, useToast, useUserStore } from '@kacat/core'
      ...
      return (
        <div class="survey-form-editor-view__render">
          ...
          <img
            ...
            src="https://dev-cdn.kacat.cn/upload/5e97376a7d789a59c3dd7db2602ccf30.jpg"
          />
