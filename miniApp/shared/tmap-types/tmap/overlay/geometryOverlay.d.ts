...
declare namespace TMap {
  ...
  type GeometryOverlayEventListener<T extends Geometry> = (event: GeometryOverlayEvent<T>) => void
  ...
  type GeometryOverlayAnimateEventName = 'move_ended' | 'move_stopped' | 'move_paused' | 'move_resumed'
  ...
  class GeometryOverlay {
    ...
    on<T extends Geometry>(eventName: GeometryEventName, listener: GeometryOverlayEventListener<T>): this

    on(eventName: GeometryOverlayMovingEventName, listener: GeometryOverlayMovingEventListener): this
    ...
    off<T extends Geometry>(eventName: GeometryEventName, listener: GeometryOverlayEventListener<T>): this

    off(eventName: GeometryOverlayMovingEventName, listener: GeometryOverlayMovingEventListener): this
