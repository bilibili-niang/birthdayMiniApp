...
declare namespace TMap {
  namespace geometry {
     ...
     * @param distance 距离
     */
    function computeDestination(start: LatLng, heading: number | LatLng, distance: number): LatLng
    /**
     * 计算点到直线的最短距离（单位：米）。
     * @param point 点
     * @param line 直线
     ...
     */
    function computeHeading(start: LatLng, end: LatLng, thumb?: boolean): number
    /**
     ...
     */
    function isPointOnSegment(point: LatLng, segment: LatLng[], tolerance: number): boolean
    /**
     ...
     * 判断线段是否与线段相交。
     */
    function isSegmentIntersect(segment: LatLng[], anotherSegment: LatLng[]): boolean
    /**
     * 判断折线是否自相交。
     * @param polyline
     */
     ...
     */
    function isPolygonIntersect(polygon: LatLng[], anotherPolygon: LatLng[]): boolean
  }
}
